...
public class ResidentModel extends OptionalResidentModel {
	...
	// public ResidentModel(Optional<Integer> age, Optional<String> hometown, Optional<String> profilePhoto, Optional<String> backgroundPhoto,
	...
	public ResidentModel(int age, String hometown, String biography, String profilePhoto, String backgroundPhoto, String instagram,
	...
	// 	//super(age, hometown, profilePhoto, backgroundPhoto, instagram, snapchat, x, facebook);
	// 	//super(getAge(), getHometown(), getBackgroundPhoto(), getInstagram(), getSnapchat(), getX(), getFacebook());
	// 	this.id = id;
	// 	this.firstName = firstName;
	// 	this.lastName = lastName;
	// 	this.gender = gender;
